...
| OI-002 | desktop / build | Vite warns the desktop JS chunk is >500 kB (CodeMirror, now ~805 kB with SQLite-free frontend). | WI-005 | Non-blocking. Consider code-splitting the editor/search via dynamic `import()` if startup/bundle size matters later. |

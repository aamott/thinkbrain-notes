...
`plans/wip-collaboration-low-hard.md` Architecture Decisions). This story produces the
...
- [ ] Design updates `plans/wip-collaboration-low-hard.md` and `plans/technical-decisions.md`
      if cross-cutting.
...
- `plans/wip-collaboration-low-hard.md` — Architecture Decisions (direction decided)

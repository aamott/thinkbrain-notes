/**
 * Non-component exports for the desktop panel registry.
 *
 * Split out of `panelRegistry.tsx` so that file exports only the
 * `MountedPanel` React component, satisfying `react-refresh/only-export-components`.
 * Everything here — context/id types, the built-in panel table, the registry
 * factory/instance, lookup helpers, and the live-contribution hooks — is data,
 * types, or hooks rather than render components, so fast-refresh has nothing
 * to invalidate in this module.
 */
import {

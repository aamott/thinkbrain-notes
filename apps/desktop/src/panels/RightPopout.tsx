...
export function RightPopout({ panel, rootPath, documentContents }: RightPopoutProps) {
  ...
  if (!contribution) {
    return (
      <aside
        className="flex flex-col min-w-0 overflow-hidden bg-sidebar border-l border-border flex-[0_0_var(--tn-shell-right-width)] max-[760px]:absolute max-[760px]:top-0 max-[760px]:bottom-0 max-[760px]:right-0 max-[760px]:z-30 max-[760px]:overflow-visible max-[760px]:shadow-panel-right"
